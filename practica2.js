...
const asesoramientoMembresiaGratuita = asesoramiento.find((item)=>item.precio === 0);
const membresiaGratuita = [];
const membresiaClasica = [];
...
while(dni.length >= 7){
    if(dni >= 45000000){
        ...
        let membresia = Number(prompt("Ingrese el numero del tipo de membresia que desea \n1 - Premium \n2 - Clasica\n3 - Gratuita"));
            if(membresia === 3 ){
                membresiaGratuita.push(asesoramientoMembresiaGratuita),
                membresiaGratuita.push(contenido);
                for (const objeto of membresiaGratuita){
